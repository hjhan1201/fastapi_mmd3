...
def Getquiz(api, topic, years, temperature):
    ...
    Remember that You must put like [quiz(json from), quizquiz(json from), quizquiz(json from)]
    {again}
    """
    ...
    while trial < attempt and answer_check:
        if answer[0] == '[' and answer[-1] == ']':
            ...
            answer = chain.invoke({"topic": topic, "years":years, "again":"I said three quiz and just List and json form! Must start with [ and end with ]"}).content
            print(answer)
